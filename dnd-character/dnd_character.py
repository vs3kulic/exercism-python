...
class Character:
    ...
    def __init__(self):
        ...
        self.hitpoints = INITIAL_HITPOINTS + Character.modifier(self.constitution)
...
def main():
    ...
    print(f"Strength: {char.strength}, Modifier: {char.modifier(char.strength)}")
    print(f"Dexterity: {char.dexterity}, Modifier: {char.modifier(char.dexterity)}")
    print(f"Constitution: {char.constitution}, Modifier: {char.modifier(char.constitution)}")
    print(f"Intelligence: {char.intelligence}, Modifier: {char.modifier(char.intelligence)}")
    print(f"Wisdom: {char.wisdom}, Modifier: {char.modifier(char.wisdom)}")
    print(f"Charisma: {char.charisma}, Modifier: {char.modifier(char.charisma)}")
