...
def fill_layer(matrix, top, bottom, left, right, num):
    """
...
# Helper functions
# -----------------
def fill_top(matrix, row, start, end, num):
...
def fill_right(matrix, col, start, end, num):
...
def fill_bottom(matrix, row, start, end, num):
...
def fill_left(matrix, col, start, end, num):
